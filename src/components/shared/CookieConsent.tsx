  ...
  const t =
    locale === 'fr'
      ? {
          ...
          body: "Avec votre accord, Google Analytics nous aide à comprendre les visites et à améliorer Naano. Les URLs sensibles et techniques sont exclues. Vous pouvez modifier votre choix à tout moment via Cookies. ",
      ...
      : {
          ...
          body: 'With your permission, Google Analytics helps us understand visits and improve Naano. Sensitive and technical URLs are excluded. You can change your choice at any time via Cookies. ',
    ...
    <>
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-1.5 text-sm leading-6 text-slate-300">
                {t.body}
                <Link to="/privacy" className="font-medium text-blue-300 underline underline-offset-2 hover:text-blue-200">
                  {t.privacy}
                </Link>
              </p>
            </div>
      ...
      {!open && (
        <button
          ...
          className="fixed right-3 bottom-3 z-[2147483645] min-h-10 rounded-full border border-white/15 bg-[#07101f]/90 px-3.5 py-2 text-xs font-semibold text-slate-200 shadow-lg backdrop-blur transition hover:bg-[#0d1a2e] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
          style={{ fontFamily: 'var(--font-inter), -apple-system, sans-serif' }}
        >
          {t.cookies}
        </button>
