 ...
 * Naano is" intro paragraph is translated, so `fr` reuses `en` for the rest.
 */
export const selectionMeta = {
  title: 'Find LinkedIn Creators for B2B — Free Creator Search | Naano',
  description:
    'Find the LinkedIn creators your B2B buyers already trust. Describe your campaign and a real person at Naano hand-builds your shortlist — with pricing and audience fit — within 48 hours. Free, no account, no commitment.',
}
...
export const selectionHero = {
  ...
  subBefore: "Skip weeks of manual sourcing. Tell us what you're launching, and a real person at Naano hand-picks the creators worth contacting — with pricing and audience fit — ",
...
export const selectionAside = {
  ...
  sourced: { title: 'Sourced by the Naano campaign team', body: 'Inside our marketplace and beyond it.' },
}
...
export const selectionManaged = { question: 'Want Naano to run the entire campaign?', cta: 'Talk to the managed campaigns team →' }
...
export const selectionHowTo = {
  ...
  steps: [
    { title: 'Describe your campaign', body: 'Tell us what you sell, who your buyer is, and roughly what budget you are working with. Four fields, about two minutes.' },
    {
      ...
      body: 'A member of the Naano campaign team searches inside the Naano marketplace and across the wider LinkedIn ecosystem for creators whose audience genuinely overlaps your buyer.',
    },
    ...
    { title: 'Book or take the list and go', body: 'Book the creators through Naano at a flat fee per post from €20, or use the shortlist however you want — there is no obligation.' },
  ],
}
...
const whatIsNaanoEn: WhatIsNaano = {
  title: 'First time here? What Naano is.',
  introBefore: 'Naano is a ',
  ...
  facts: [
    ...
    { value: 'No invoices', label: 'Naano pays creators directly, so salaried experts can take part without a registered company.' },
  ],
  ...
  items: [
    {
      ...
      a: "Three routes. Search LinkedIn manually by job title and topic, which is free but slow and gives you no pricing or willingness-to-post signal. Use a creator database such as Favikon, which surfaces who exists but stops before booking. Or use a B2B creator marketplace, where creators have already published their price and opted in to sponsored posts. Naano's free creator search does the third route for you: describe your campaign and a real person returns a shortlist with pricing and audience fit within 48 hours.",
    },
    {
      q: 'Is the Naano creator search really free?',
      a: 'Yes. There is no cost, no account required, and no payment method requested. You keep the shortlist whether or not you run a campaign with Naano, including if you decide to contact the creators directly yourself.',
    },
    {
      q: 'How long does it take to receive the shortlist?',
      a: 'Within 48 hours. It is built by a member of the Naano campaign team rather than generated automatically, which is why it takes hours rather than seconds — and why every profile comes with a reason it belongs in your campaign.',
    },
    {
