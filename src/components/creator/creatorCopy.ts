...
const en: CreatorCopy = {
  ...
  ctaBody: 'Book this creator for a LinkedIn post on Naano - fixed price, you keep full creative alignment, they keep their voice.',
  ctaButton: 'Get started on Naano',
  ctaPoints: ['Fixed price per post', 'Keeps their authentic voice', 'Booked & paid on Naano'],
  whatIsNaanoTitle: 'What is Naano',
  whatIsNaanoBody:
