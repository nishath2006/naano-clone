...
const copy = {
  en: {
    ...
    sub: '2,000+ creators already getting paid on NaanoX.',
    stats: [
      ['2,000+', 'Creators'],
      ['€500', 'Avg. per deal'],
      ['€1,500', 'Top deal'],
    ...
    reviews: [
      { text: 'NaanoX is the marketplace LinkedIn was missing. The founders truly listen and do everything they can to build something that brings real value to its users.', name: 'Raphael Alfero', meta: 'B2B creator · 18K followers', avatar: '/lp/avatar-d.png' },
      ...
      { text: 'NaanoX lets me keep making useful content while monetizing my LinkedIn community. We never give up!', name: 'Eric Djavid', meta: 'LinkedIn creator · 40K followers', avatar: '/lp/avatar-b.png' },
      { text: "A young team that's ambitious, efficient and driven. Super proactive and always listening. I'd tell every creator to join NaanoX!", name: 'Nada Ait Ouchene', meta: 'Marketing creator · 11K followers', avatar: '/lp/avatar-a.png' },
    ] as Review[],
  },
  fr: {
    eyebrow: 'DE LA COMMUNAUTÉ',
    title: 'Ce que disent les créateurs',
    sub: '2 000+ créateurs déjà payés sur NaanoX.',
    stats: [
      ['2,000+', 'Créateurs'],
    ...
    reviews: [
      { text: 'NaanoX est la marketplace qui manquait à LinkedIn. Les fondateurs écoutent vraiment et font tout pour construire quelque chose qui apporte de la vraie valeur.', name: 'Raphael Alfero', meta: 'Créateur B2B · 18K abonnés', avatar: '/lp/avatar-d.png' },
      ...
      { text: "NaanoX me permet de continuer à créer du contenu utile tout en monétisant ma communauté LinkedIn. On n'abandonne jamais !", name: 'Eric Djavid', meta: 'Créateur LinkedIn · 40K abonnés', avatar: '/lp/avatar-b.png' },
      { text: "Une jeune équipe ambitieuse, efficace et motivée. Super proactive et toujours à l'écoute. Je dirais à chaque créateur de rejoindre NaanoX !", name: 'Nada Ait Ouchene', meta: 'Créatrice marketing · 11K abonnés', avatar: '/lp/avatar-a.png' },
    ] as Review[],
  },
}
