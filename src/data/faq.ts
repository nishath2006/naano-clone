...
export const HOME_FAQ: { en: Faq[]; fr: Faq[] } = {
  ...
  fr: [
    ...
    },
    {
      ...
      a: "Naano place un pixel de suivi à chaque étape du funnel : chaque clic, lead, opportunité dans le pipeline et revenu est attribué au créateur et au post qui l'a généré.",
    },
    {
    ...
    },
    {
      ...
      a: "Free donne à votre équipe la plateforme pour sourcer des créateurs et gérer elle-même des campagnes simples. Done for you ajoute l'exécution par l'équipe Naano : sourcing, briefs, reporting et optimisation.",
    },
    {
...
export const CREATORS_FAQ: { en: Faq[]; fr: Faq[] } = {
  en: [
    ...
    { q: 'Is Naano free for creators?', a: 'Yes, always. Joining and using Naano is completely free, and you keep 100% of what you earn on every deal.' },
    {
  ...
  fr: [
    {
      q: "Qu'est-ce que Naano ?",
      a: "Naano est la marketplace de créateurs LinkedIn B2B : les marques B2B y réservent des créateurs pour des posts LinkedIn sponsorisés, à un prix fixe par post que vous définissez. Des créateurs d'environ 1 000 à 500 000 abonnés utilisent Naano pour monétiser leur audience LinkedIn avec des deals de marques B2B qu'ils connaissent déjà.",
    },
    { q: 'Naano est-il gratuit pour les créateurs ?', a: 'Oui, toujours. Rejoindre et utiliser Naano est entièrement gratuit, et vous gardez 100 % de ce que vous gagnez sur chaque deal.' },
    {
    ...
    {
      q: 'Quelles marques sont sur Naano ?',
