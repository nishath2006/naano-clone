...
export const marketplaceCopy: { en: MarketplaceCopy; fr: MarketplaceCopy } = {
  en: {
    title: 'LinkedIn Creator Marketplace for B2B Brands — NaanoX',
    description:
      "NaanoX is the B2B LinkedIn creator marketplace: book vetted LinkedIn creators at a fixed price per post, with payment and tracking handled — available in Europe today, unlike LinkedIn's US-only alpha.",
    hero: {
      h1: 'The LinkedIn creator marketplace built for B2B',
      lede: 'A LinkedIn creator marketplace is a platform where companies find, book, and pay LinkedIn creators for sponsored posts. NaanoX is the B2B version: 2,000+ vetted creators from about 1,000 to 500,000 followers, each with a fixed price per post shown before booking — live in Europe today.',
    ...
    how: {
      ...
      steps: [
        { title: 'Match', body: 'Define your vertical and ICP; NaanoX surfaces vetted creators whose audience contains your buyers, in the language your buyers read.' },
        ...
        { title: 'Pay', body: 'Each creator sets a fixed price per post, shown before booking. NaanoX handles the payment, so creators never have to invoice your company.' },
    ...
    vs: {
      h2: "NaanoX vs LinkedIn's native Creator Marketplace",
      ...
      head: ['Dimension', 'LinkedIn Creator Marketplace', 'NaanoX'],
      rows: [
      ...
      note: [
        ...
        { t: 'LinkedIn Creator Marketplace vs NaanoX', href: '/blog/linkedin-creator-marketplace-vs-naano' },
        '.',
      ],
    },
    cost: {
      h2: 'What sponsored LinkedIn posts cost',
      lede: 'On NaanoX, each creator sets a fixed price per post, shown before booking. The NaanoX Index — 239 real sponsored-post bookings on the marketplace between June 14 and August 1, 2026 — puts numbers on what brands actually pay:',
      tiles: [
    ...
    who: {
      h2: 'Who NaanoX is for',
      p: [
        'NaanoX is built for B2B teams whose buyers are on LinkedIn — B2B SaaS companies above all, along with agencies and marketing teams selling to professional audiences. If your pipeline depends on reaching founders, operators, or specialists in a vertical, the creators they already follow are the distribution channel, and a marketplace is the fastest way to book them. If your buyers are consumers on Instagram or TikTok, a consumer influencer platform is a better structural fit — our ',
        { t: '2026 platform comparison', href: '/best-b2b-influencer-marketing-platforms-2026' },
        ' covers those honestly.',
      ],
      h3: 'Is NaanoX a LinkedIn influencer marketing platform?',
      p2: [
        'Yes. "Influencer marketing platform" and "creator marketplace" describe the same job from two angles. NaanoX does that job for LinkedIn specifically: instead of a searchable database you export and chase by email, it is a transactional marketplace where you book a vetted creator at a fixed price per post and the platform handles briefing, payment, and per-post tracking. Plans are Self-Serve at €0/month and Managed at €700/month — see ',
      ...
      items: [
        {
          ...
          a: "Yes. LinkedIn's own Creator Marketplace (announced June 10, 2026) is an alpha limited to advertisers in the US and Canada, with English-language content only and no announced European date. NaanoX is a B2B LinkedIn creator marketplace that is live in Europe today, with 2,000+ vetted creators publishing in local languages.",
        },
        {
          q: "What is the difference between NaanoX and LinkedIn's Creator Marketplace?",
          a: "LinkedIn's Creator Marketplace is a creator discovery tool inside Campaign Manager: brands search opted-in creators, see native follower and engagement data, and contact them by email — payment, contracting, and tracking remain the brand's problem. NaanoX is an end-to-end marketplace: brands book vetted LinkedIn creators at a fixed price per post, and the platform handles briefing, publishing, payment, and per-post tracking. LinkedIn's product is also US/Canada-only alpha, while NaanoX operates in Europe today.",
        },
        {
          q: 'How much does a sponsored LinkedIn post cost?',
          a: 'Based on 239 real sponsored-post bookings on the NaanoX marketplace between June 14 and August 1, 2026, the median transacted price was €84 per post for creators under 5,000 followers, €180 at 5,000–10,000 followers, and €312 at 10,000–25,000 followers. On NaanoX, each creator sets a fixed price per post, shown before booking — there is no cost per click or per impression.',
        },
        {
          q: 'Is NaanoX an influencer marketing platform?',
          a: 'Yes — NaanoX is a LinkedIn influencer marketing platform, structured as a marketplace rather than a database: instead of exporting a list of profiles and running outreach yourself, you book a vetted LinkedIn creator at a fixed price per post and the platform handles matching, briefing, payment, and tracking. It is built exclusively for B2B brands on LinkedIn.',
        },
        {
          q: 'How do creators get paid?',
          a: "NaanoX handles the payment. The fixed per-post fee is known before the post goes live, and the platform pays the creator after publication — creators never issue brand-by-brand invoices, which matters because most active B2B creators are salaried professionals. LinkedIn's own Creator Marketplace does not handle payment; its monetization tools were announced with no launch date.",
        },
        {
          q: 'How much does NaanoX cost?',
          a: "There are two plans: Self-Serve at €0/month, where you pay only the fixed per-post fee each creator has set, and Managed at €700/month, where NaanoX handles creator selection, briefs, and campaign management. Every creator's price is a flat fee per post, shown before booking.",
        },
      ],
    },
    cta: {
  ...
  fr: {
    title: 'Marketplace de créateurs LinkedIn pour les marques B2B — NaanoX',
    description:
      "NaanoX est la marketplace de créateurs LinkedIn B2B : réservez des créateurs vérifiés à un prix fixe par post, avec paiement et tracking gérés — disponible en Europe aujourd'hui, contrairement à la version alpha de LinkedIn limitée aux États-Unis.",
    hero: {
      h1: 'La marketplace de créateurs LinkedIn conçue pour le B2B',
      lede: "Une marketplace de créateurs LinkedIn est une plateforme où les entreprises trouvent, réservent et paient des créateurs LinkedIn pour des posts sponsorisés. NaanoX en est la version B2B : plus de 2 000 créateurs vérifiés, d'environ 1 000 à 500 000 abonnés, chacun avec un prix fixe par post affiché avant la réservation — disponible en Europe aujourd'hui.",
    ...
    what: {
      ...
      p2: "La distinction importante pour une équipe acheteuse concerne le périmètre. Un outil de découverte vous indique qui sont les créateurs. Une marketplace de bout en bout gère aussi la suite : réservation, brief, paiement et tracking par post. NaanoX appartient à cette deuxième catégorie et se consacre exclusivement au B2B — les entreprises y trouvent et réservent des créateurs LinkedIn vérifiés, d'environ 1 000 à 500 000 abonnés, à un prix fixe par post défini par chaque créateur et affiché avant la réservation.",
    },
    how: {
      h2: 'Comment fonctionne NaanoX',
      ...
      steps: [
        { title: 'Matching', body: "Définissez votre secteur et votre ICP ; NaanoX fait remonter des créateurs vérifiés dont l'audience comprend vos acheteurs, dans la langue qu'ils lisent." },
        ...
        { title: 'Paiement', body: "Chaque créateur fixe un prix par post, affiché avant la réservation. NaanoX gère le paiement afin que les créateurs n'aient jamais à facturer votre entreprise." },
    ...
    vs: {
      h2: 'NaanoX face à la Creator Marketplace native de LinkedIn',
      ...
      head: ['Critère', 'Marketplace de créateurs LinkedIn', 'NaanoX'],
      rows: [
    ...
    cost: {
      ...
      lede: 'Sur NaanoX, chaque créateur fixe un prix par post, affiché avant la réservation. Le NaanoX Index — 239 réservations réelles de posts sponsorisés sur la marketplace entre le 14 juin et le 1er août 2026 — montre ce que les marques paient réellement :',
      tiles: [
      ...
      items: [
        {
          ...
          a: "Oui. La Creator Marketplace de LinkedIn, annoncée le 10 juin 2026, est une version alpha limitée aux annonceurs des États-Unis et du Canada, avec du contenu en anglais uniquement et aucune date annoncée pour l'Europe. NaanoX est une marketplace de créateurs LinkedIn B2B disponible en Europe aujourd'hui, avec plus de 2 000 créateurs vérifiés publiant dans les langues locales.",
        },
        {
          q: 'Quelle est la différence entre NaanoX et la Marketplace de créateur de LinkedIn ?',
          a: "La Creator Marketplace de LinkedIn est un outil de découverte intégré à Campaign Manager : les marques recherchent des créateurs inscrits, consultent leurs données natives d'abonnés et d'engagement, puis les contactent par e-mail — le paiement, les contrats et le tracking restent à la charge de la marque. NaanoX est une marketplace de bout en bout : les marques réservent des créateurs LinkedIn vérifiés à un prix fixe par post, et la plateforme gère le brief, la publication, le paiement et le tracking de chaque post. Le produit de LinkedIn est également une version alpha limitée aux États-Unis et au Canada, tandis que NaanoX opère déjà en Europe.",
        },
        {
          q: 'Combien coûte un post LinkedIn sponsorisé ?',
          a: "D'après 239 réservations réelles de posts sponsorisés sur la marketplace NaanoX entre le 14 juin et le 1er août 2026, le prix médian payé était de 84 € par post pour les créateurs de moins de 5 000 abonnés, 180 € entre 5 000 et 10 000 abonnés et 312 € entre 10 000 et 25 000 abonnés. Sur NaanoX, chaque créateur fixe un prix par post, affiché avant la réservation — il n'y a aucun coût au clic ni à l'impression.",
        },
        {
          q: "NaanoX est-il une plateforme de marketing d'influenceurs ?",
          a: "Oui — NaanoX est une plateforme d'influence marketing LinkedIn structurée comme une marketplace plutôt que comme une base de données : au lieu d'exporter une liste de profils et de gérer vous-même la prospection, vous réservez un créateur LinkedIn vérifié à un prix fixe par post, puis la plateforme gère le matching, le brief, le paiement et le tracking. Elle est conçue exclusivement pour les marques B2B sur LinkedIn.",
        },
        {
          q: 'Comment les créateurs sont-ils payés ?',
          a: "NaanoX gère le paiement. Le forfait par post est connu avant la publication, puis la plateforme paie le créateur après la mise en ligne — les créateurs n'émettent jamais de facture pour chaque marque, ce qui compte puisque la plupart des créateurs B2B actifs sont salariés. La Creator Marketplace de LinkedIn ne gère pas le paiement ; ses outils de monétisation ont été annoncés sans date de lancement.",
        },
        {
          q: 'Combien coûte NaanoX ?',
          a: 'Deux formules sont proposées : Self-Serve à 0 €/mois, où vous payez uniquement le forfait par post fixé par chaque créateur, et Managed à 700 €/mois, où NaanoX gère la sélection des créateurs, les briefs et la campagne. Le prix de chaque créateur est un forfait par post affiché avant la réservation.',
        },
      ],
    },
    cta: {
