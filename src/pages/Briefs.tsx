...
const LINK = { color: '#1652F0', textDecoration: 'none', fontWeight: 600 } as const
...
const intro = {
  en: "B2B brands publish campaign briefs on Naano to find vetted LinkedIn creators for flat-fee sponsored posts. Each brief describes the brand's context, tone, content angles and targeting — pick a campaign that fits your audience and apply, or ",
  fr: 'Les marques B2B publient des briefs de campagne sur Naano pour trouver des créateurs LinkedIn vérifiés et leur confier des posts sponsorisés au forfait. Chaque brief présente le contexte de la marque, le ton, les angles de contenu et le ciblage : choisissez une campagne adaptée à votre audience et postulez, ou ',
}
...
export default function Briefs() {
  ...
  return (
    <StandaloneShell
      title="Open LinkedIn creator campaigns — briefs | Naano"
      description="Browse open campaign briefs from B2B brands looking for LinkedIn creators on Naano. Flat-fee sponsored posts, full creative control — apply as a creator or launch your own campaign."
      background="#FAFAF9"
    >
      <main
        style={{
      ...
      >
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '28px 20px 64px' }}>
          ...
          >
            ...
            <Link to="/register?role=influencer" style={{ fontSize: 12.5, fontWeight: 600, color: '#1652F0', textDecoration: 'none', whiteSpace: 'nowrap' }}>
              Apply as a creator →
            </Link>
          </header>
