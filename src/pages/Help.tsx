...
const copy = {
  en: {
    title: 'NaanoX Help Center: campaigns, pricing & payouts',
    description:
      'Answers to common questions about NaanoX: fixed-price creator campaigns, matching, payouts, and performance dashboards for B2B SaaS and creators.',
    h1: 'Help Center',
...
export default function Help() {
  ...
  return (
    <SiteLayout title={c.title} description={c.description} deps={[locale]}>
      <section className="pt-32 sm:pt-36 md:pt-44 pb-16 sm:pb-20 px-4 sm:px-6 bg-gradient-to-b from-[#F7F4FF]/50 to-white">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="py-4 fade-up">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-2.5 rounded-xl bg-[#F7F4FF] text-[#7C5CFC]">
            ...
            <p className="text-[#4B5563] leading-relaxed text-lg">
              {c.before}
              <a href={`mailto:${EMAIL}`} className="text-[#7C5CFC] hover:text-[#7C5CFC] font-medium underline">
                {EMAIL}
              </a>
              {c.between}
              <a
                ...
                className="inline-flex items-center gap-1.5 text-[#7C5CFC] hover:text-[#7C5CFC] font-medium underline"
              >
                LinkedIn
          ...
          <div className="mt-8 text-center fade-up">
            <Link className="text-sm text-[#7C5CFC] hover:text-[#7C5CFC] font-medium" to="/">
              ← {c.back}
            </Link>
          </div>
        </div>
