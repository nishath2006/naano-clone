...
const VERDICTS = {
  ...
  fair: { label: 'Mixed odds', className: 'bg-[#E8F0FE] text-[#1652F0] border border-[#1652F0]/20' },
      ...
      <div className="mt-8 border-t border-[#ECEAE6] pt-8">
        {result === null ? (
          ...
          <div>
            ...
            <p className="mt-5 text-[28px] sm:text-[34px] font-semibold leading-tight tracking-[-0.02em] text-[#1652F0]">
...
const FAQ = [
  ...
  },
  {
    ...
    a: '€84 per post for a creator under 5,000 followers, €180 for 5,000–10,000, €300 for 10,000–25,000, €588 for 25,000–50,000, and €720 above 50,000 followers. These are transacted prices, brand-side and excluding VAT, from bookings placed on Naano between June and August 2026 [Naano Index, n=300].',
  },
  {
...
const EN = {
  ...
  bandsIntro:
    'Every sponsored-post booking created on Naano between 14 June and 1 August 2026, excluding bookings still awaiting a decision from the delivery-rate denominator. “Never answered” means the offer window closed without the creator responding at all.',
  bandsHeaders: ['Price per post', 'Bookings', 'Published', 'Never answered'],
  source: '[Naano Index, n=300 bookings, 14 June – 11 August 2026]',
  ...
  dark: {
    ...
    text: 'Every creator on Naano publishes their own flat fee per post, so you never open with a number you had to invent. Contracts, escrow and invoicing handled — no monthly platform fee.',
...
const COPY = {
  ...
  fr: {
    ...
    source: '[Naano Index, n=300 bookings, 14 juin – 11 août 2026]',
        ...
        <DataTable
          ...
          rows={TIERS.map((t) => ({
            ...
            cells: [
              ...
              { className: 'px-5 py-4 font-semibold text-[#1652F0]', content: euro(t.median) },
