...
const copy = {
  en: {
    ...
    description: 'Naano separates brand operations from creator management. Choose your setup and create the right workspace for your agency.',
    badge: 'Naano for agencies',
    h1: 'Choose the workspace that matches your agency.',
    p: 'Naano separates brand operations from creator management. Choose your setup and create the right workspace for your agency.',
    ...
    callCta: 'Book a call',
    callNote: '30 minutes with the Naano team. No commitment.',
  },
  fr: {
    title: 'Naano pour les agences — Opérations marques et créateurs',
    description: 'Naano sépare les opérations pour les marques de la gestion des créateurs. Choisissez votre configuration et créez le bon workspace pour votre agence.',
    badge: 'Naano pour les agences',
    h1: 'Choisissez le workspace adapté à votre agence.',
    p: 'Naano sépare les opérations pour les marques de la gestion des créateurs. Choisissez votre configuration et créez le bon workspace pour votre agence.',
    ...
    cards: [
      ...
      },
      {
        ...
        href: '/talent-agency',
        note: 'Vos créateurs n’ont pas besoin de comptes Naano individuels.',
      },
    ],
    callEyebrow: 'Échangez avec Naano',
    ...
    callNote: '30 minutes avec l’équipe Naano. Sans engagement.',
  },
}
